...
import me.rina.gui.impl.overlay.component.widget.ComponentWidget;
...
public class ComponentListFrame extends Frame {
    ...
    public void init() {
        ...
        for (Component components : BubbyClient.INSTANCE.getComponents().getComponentList()) {
    ...
    public void onRender() {
        ...
        TurokRenderGL.drawSolidRectFadingMouse(this.rect.getX(), this.rectOffset.getY() + this.rectOffset.getHeight() - 2, offsetX + TurokFontManager.getStringWidth(this.master.fontComponentListFrame, this.rect.getTag()) + 2, 1, 50, new Color(this.master.guiColor.base[0], this.master.guiColor.base[1], this.master.guiColor.base[2], 255));
