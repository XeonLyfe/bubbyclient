...
public class SettingBooleanWidget extends Widget {
    ...
    public SettingBooleanWidget(ModuleClickGUI master, CategoryFrame frame, ModuleScrollContainer container, ModuleWidget module, final Setting<Boolean> setting) {
    ...
    public void onMouseReleased(int button) {
        if (this.flagMouse == Flag.MouseOver) {
            if (this.isMouseClickedLeft) {
                this.setting.set(!this.setting.getValue());
